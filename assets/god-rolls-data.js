...
window.GodRollsData = (function(){
  const WEAPONS = [
    { name:"Blast Furnace", slug:"blast-furnace",
      itemHash: 52683113,
      perkHashes: [3048246338, 3267421167, 1549370717, 1183436451, 2034764268],
    ...
    { name:"Hullabaloo", slug:"hullabaloo",
      itemHash: 2449096504,
      perkHashes: [373417387, 2108812838, 1720528630, 598607952, 2523469161],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"M-17 \"Fast Talker\"", slug:"m-17-fast-talker",
      itemHash: 1419158093,
      perkHashes: [3048246338, 226831738, 984655331, 2939589096, 4280607931],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Terminus Horizon", slug:"terminus-horizon",
      itemHash: 3814261872,
      perkHashes: [2860123632, 1709045111, 65604327, 4065965131, 1043703792],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Chroma Rush", slug:"chroma-rush",
      itemHash: 771811871,
      perkHashes: [3048246338, 3267421167, 4245865861, 1549370717, 261199142],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Wendigo GL3", slug:"wendigo-gl3",
      itemHash: 4021098353,
      perkHashes: [373417387, 409713597, 3528046508, 2275087323, 2223800157],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Corrective Measure", slug:"corrective-measure",
      itemHash: 3654744298,
      perkHashes: [3048246338, 1065371964, 1926441324, 2896748467, 716643564],
    ...
    { name:"VS Velocity Baton", slug:"vs-velocity-baton",
      itemHash: 2452936816,
      perkHashes: [373417387, 2108812838, 2541826827, 1926441324, 4232410959],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"The Summoner", slug:"the-summoner",
      itemHash: 2884908760,
      perkHashes: [1932356121, 1968098204, 4223976499, 2675184851, 1939575288],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"The Recluse", slug:"the-recluse",
      itemHash: 3257283337,
      perkHashes: [1871180748, 1968098204, 2541826827, 1926441324, 2544048574],
      raidSlug: null, dungeonSlug: null,
      note: "",
      buildTags: [],
      pairing: null },
    { name:"Lotus-Eater", slug:"lotus-eater",
      itemHash: 924095500,
      perkHashes: [373417387, 1065371964, 2541826827, 1926441324, 2223800157],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Qua-Vinctus IV", slug:"qua-vinctus-iv",
      ...
      perkHashes: [111235976, 3267421167, 102912326, 2896748467, 2671305723],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"LIONFISH-4FR", slug:"lionfish-4fr",
      itemHash: 2423071981,
      perkHashes: [3048246338, 1279785143, 461595545, 344235611, 2223800157],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Ribbontail", slug:"ribbontail",
      itemHash: 3576134513,
      perkHashes: [3048246338, 3081681954, 4245865861, 2896748467, 483923727],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Action Item", slug:"action-item",
      itemHash: 527989828,
      perkHashes: [3966296580, 2680121939, 2617553311, 2078520142, 1209885908],
      raidSlug: null, dungeonSlug: null,
      note: "",
    ...
    { name:"Festival Flight", slug:"festival-flight",
      itemHash: 4019651319,
      perkHashes: [3525010810, 2822142346, 3523296417, 831391274, 1198287879],
      raidSlug: null, dungeonSlug: null,
      note: "",
    ...
    { name:"Mint Retrograde", slug:"mint-retrograde",
      itemHash: 3285784871,
      perkHashes: [3471392239, 2108812838, 102912326, 598607952, 2223800157],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Tinasha's Mastery", slug:"tinashas-mastery",
      itemHash: 247984828,
      perkHashes: [373417387, 1709045111, 561986700, 344235611, 1831023215],
      raidSlug: null, dungeonSlug: null,
      note: "",
    ...
    { name:"Reckless Oracle", slug:"reckless-oracle",
      itemHash: 4158265643,
      perkHashes: [839105230, 3142289711, 2048641572, 3640170453, 2407733996],
      raidSlug: null, dungeonSlug: null,
      note: "",
    ...
    { name:"Threat Level", slug:"threat-level",
      itemHash: 1523151869,
      perkHashes: [1482024992, 2420895100, 3751912585, 1226351311, 2407733996],
      raidSlug: null, dungeonSlug: null,
      note: "",
    ...
    { name:"Conspiracy (Honed)", slug:"conspiracy-honed",
      itemHash: 4062069077,
      perkHashes: [1840239774, 807993149, 1546637391, 3078487919, 2957461671],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Refurbished A-499", slug:"refurbished-a499",
      itemHash: 3661051060,
      perkHashes: [839105230, 3142289711, 588594999, 3764420437, 4280607931],
    ...
    { name:"Duty Bound", slug:"duty-bound",
      itemHash: 260532765,
      perkHashes: [3048246338, 1783397184, 3914874605, 288411554, 2223800157],
      raidSlug: null, dungeonSlug: null,
    ...
    { name:"Prosecutor", slug:"prosecutor",
      itemHash: 1091550016,
      perkHashes: [3966296580, 1968098204, 169755979, 1720528630, 2415292777],
